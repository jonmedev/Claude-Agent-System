---
name: topus
description: "Topus v3.0 — Flagship dual-mode orchestrator with PLAN/EXECUTE auto-detection, domain-expert agents, graph exploration, knowledge bus, confidence scoring, wave-based execution, inter-agent signal bus, adaptive scaling, --scout-model/--resume/--hotfix flags, and Memory Bank integration."
model: opus
